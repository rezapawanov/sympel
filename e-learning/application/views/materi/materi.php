          ...
          <div class="animated fadeInUp col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               ...
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/materi_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
           </div>
              </div>
              <!-- /.card-header -->
                    ...
                    <?php
                                ...
                                <tr class="text-sm">
                                    ...
                                    <td style="text-align:center; ">
                                        ...
                                        <a class="btn bg-navy btn-xs detail-materi" href="#" data-toggle="modal" data-target="#modalView" data-id_materi="<?php echo $data['id_materi']; ?>"><i class="fa fa-eye"> </i></a>
                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'master/materi_edit/' . $data['id_materi']; ?>"><i class="fa fa-edit"> </i></a>
                                    </div>
                                    </td>
                                </tr>
                                <?php $no++;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title text-info"><i class="far fa-upload"></i></i> Import Data Materi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
            <form action="<?php echo base_url(); ?>master/materi_import" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <p style="margin:0;">- Format Data Perpustakaan dapat di unduh <a href="<?php echo base_url(); ?>upload/format/materi_import.xlsx" target="_blank"> <i class="fal fa-download"></i> DISINI</a></a>
              </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-teal">
              <h4 class="modal-title"><i class="nav-icon fad fa-materis-medical text-white"></i> Detail Materi</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script>
    $(".detail-materi").click(function() {
        ...
        $.get("<?php echo base_url(); ?>master/ajax_detail_materi", {
            id_materi: id_materi
        }, function(data) {
