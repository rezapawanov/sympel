          ...
          <div class="animated fadeInUp col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               ...
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/book_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
               <a class="btn btn-danger btn-sm" href="" data-toggle="modal" data-target="#modalImport"><i class="fas fa-file-excel"> </i> Import Excel</a>
               <a class="btn bg-navy btn-sm" href="<?php echo base_url(); ?>master/book_export" target="_blank"><i class="fa fa-download"> </i> Download Data Buku</a>
           </div>
              </div>
              <!-- /.card-header -->
                    ...
                    <?php
                                ...
                                <tr class="text-sm">
                                    ...
                                    <td style="text-align:center; ">
                                        ...
                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'master/book_edit/' . $data['id_buku']; ?>"><i class="fa fa-edit"> </i></a>
                                    </div>
                                    </td>
                                </tr>
                                <?php $no++;
          ...
          <div class="modal-content">
            ...
            <form action="<?php echo base_url(); ?>master/book_import" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <p style="margin:0;">- Format Data Perpustakaan dapat di unduh <a href="<?php echo base_url(); ?>upload/format/book_import.xlsx" target="_blank"> <i class="fal fa-download"></i> DISINI</a></a>
              </div>
