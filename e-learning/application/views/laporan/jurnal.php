          ...
          <div class=" col-md-12">
            <div class="card card-info card-outline">
              <div class="card-header col-md-12">
                ...
                <a><i class="fa fa-file-search text-info"> </i> Cari Data Jurnal Berdasarkan</a>
              ...
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/master/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded " style="width:60px;height:60px;">
               <br><?php echo $nama_sekolah ?></h4>
                      <h4 style="margin:0;">Daftar Jurnal</h4>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-sm"><?php echo date("d-m-Y", strtotime($data['tanggal_jurnal'])); ?></td>
                              ...
                              <td class="text-sm"><a class="btn bg-navy btn-xs detail-jurnal" href="#" data-toggle="modal" data-target="#modalView" data-id_jurnal="<?php echo $data['id_jurnal']; ?>"><i class="fa fa-eye"> </i></a>
</td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-teal">
              <h4 class="modal-title"><i class="nav-icon fad fa-jurnals-medical text-white"></i> Lihat Jurnal</h4>
...
<script>
    $(".detail-jurnal").click(function() {
        ...
        $.get("<?php echo base_url(); ?>laporan/ajax_detail_jurnal", {
            id_jurnal: id_jurnal
        }, function(data) {
