        ...
        <div class="row mb-2">
                  ...
                  <div class="col-md-12">
                    <div class="card card-green card-outline">
                      <div class="card-header">
                        <h3 class="card-title text-green"><i class="fad fa-books-medical"></i> DATA PERPUSTAKAAN</h3>
                      ...
                      <div class="card-body p-0">
                        <div class="row mt-3 ml-1 mr-1">
                          <div class="col-12 col-sm-3 col-md-3">
                            <a style="color:black;">
                            <div class="info-box">
                              <span class="info-box-icon bg-red elevation-1"><i class="fad fa-books-medical"></i></span>
                              <div class="info-box-content">
                                <span class="info-box-text text-red" ><b>DATA JURNAL</b></span>
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_jurnal; ?></span>
                              </div>
                            </div></a>
                          </div>
                          ...
                          <div class="col-12 col-sm-3 col-md-3">
                            <a style="color:black;">
                            <div class="info-box">
                              <span class="info-box-icon bg-blue elevation-1"><i class="fas fa-users-class"></i></i></span>
                              <div class="info-box-content">
                                <span class="info-box-text text-blue" ><b>DATA MATERI</b></span>
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_materi; ?></span>
                              </div>
                            </div></a>
                          </div>
          ...
          <div class="col-md-6">
            <div class="card card-blue">
              <div class="card-header">
                <h3 class="card-title"><i class="fad fa-spin fa-chart-pie"></i> Grafik Jurnal Dan Materi</h3>
...
<script>
  Highcharts.chart('pie-absen', {
    ...
    series: [{
      ...
      data: [{
        name: 'Data Jurnal',
        y: <?php echo $hitung_jurnal; ?>
      }, {
        name: 'Data Materi',
        y: <?php echo $hitung_materi; ?>
      }]
    }]
  });
</script>
...
<script>
  Highcharts.chart('pie-abseni', {
    ...
    series: [{
      ...
      data: [{
        name: 'Baca Buku',
        y: <?php echo $hitung_pengunjung_bb; ?>
      }]
    }]
  });
</script>