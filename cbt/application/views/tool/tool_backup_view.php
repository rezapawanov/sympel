		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database <?php if(!empty($site_name)){ echo $site_name; } ?>  CBT. Simpan backup database pada tempat yang aman.</p>
        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio) pada <?php if(!empty($site_name)){ echo $site_name; } ?>  CBT. Simpan backup data pada tempat yang aman.</p>
                        <p>Data file yang di upload akan disimpan dalam bentuk archive.</p>
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama <?php if(!empty($site_name)){ echo $site_name; } ?>  CBT</p>
                    </div>
		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Setelah <?php if(!empty($site_name)){ echo $site_name; } ?> CBT digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
