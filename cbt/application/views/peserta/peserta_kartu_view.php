	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Lakukan Pengaturan nama pelaksana <?php if(!empty($site_name)){ echo $site_name; } ?> CBT sebelum mencetak kartu peserta agar kartu sesuai dengan Organisasi tempat anda melaksanakan Tes.</p>
