...
<section class="content">
	...
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif <?php if(!empty($site_name)){ echo $site_name; } ?>  CBT, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
