        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/mapel_save" method="post">
                ...
                <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-save"> </i> Simpan</button>
                            <a class="btn btn-default btn-lg" href="<?php echo base_url(); ?>master/mapel"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                <!-- /.card-footer -->
              </form>
            </div>
