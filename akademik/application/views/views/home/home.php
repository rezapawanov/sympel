                          ...
                          <div class="col-12 col-sm-3 col-md-3">
                            ...
                            <div class="info-box">
                              ...
                              <div class="info-box-content">
                                ...
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_buku; ?></span>
                              </div>
                            </div></a>
                          </div>
                          ...
                          <div class="col-12 col-sm-3 col-md-3">
                            ...
                            <div class="info-box">
                              ...
                              <div class="info-box-content">
                                ...
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_pengunjung; ?></span>
                              </div>
                            </div></a>
                          </div>
                          ...
                          <div class="col-12 col-sm-3 col-md-3">
                            ...
                            <div class="info-box">
                              ...
                              <div class="info-box-content">
                                ...
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_peminjaman; ?></span>
                              </div>
                            </div></a>
                          </div>
                          ...
                          <div class="col-12 col-sm-3 col-md-3">
                            ...
                            <div class="info-box">
                              ...
                              <div class="info-box-content">
                                ...
                                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_dana_denda; ?></span>
                              </div>
                            </div></a>
                          </div>
                        </div>
  ...
  Highcharts.chart('pie-absen', {
    ...
    series: [{
      ...
      data: [{
        ...
        y: <?php echo $hitung_pengunjung_bp; ?>
      }, {
        name: 'Kembali Buku',
        y: <?php echo $hitung_pengunjung_kb; ?>
      }, {
        name: 'Pinjam Buku',
        y: <?php echo $hitung_pengunjung_pb; ?>
      }]
    }]
  });
</script>