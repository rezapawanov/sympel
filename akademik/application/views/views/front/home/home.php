...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/sympel/asispanel/upload/'.$sekolah->logo; ?>" type="image/x-icon">
          ...
          <div class="col-md-12">
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-image">
                <img class="img-rounded elevation-2" src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/sympel/asispanel/upload/'.$sekolah->logo; ?>" alt="User Avatar">
              </div>
