        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>siswa/biodata"><?php echo $judul; ?></a></li>
        ...
        <form action="<?php echo base_url(); ?>siswa/biodata_save" method="post" enctype="multipart/form-data">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="row">
                                           ...
                                           <div class="form-group col-md-3 mr-2">
                                                <div class="form-group">
                                                    <label>NISN</label>
                                                    <input type="number" class="form-control" name="nisn" value="<?php echo $nisn; ?>"  disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        <div class="row">
                                           <div class="form-group col-md-6 mr-2">
                                                <div class="form-group">
            ...
            <div class="callout callout-info">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (!empty($foto)) { ?>
                                    <img src="<?php echo base_url() . 'upload/siswa/' . $foto; ?>" class="profile-user-img img-responsive">
                                <?php } else {  ?>
                                    <img class="profile-user-img img-responsive" src="<?php echo base_url(); ?>asset/img/noimage.jpg">
                                <?php } ?>
