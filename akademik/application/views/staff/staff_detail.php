          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
                          ...
                          <?php if (!empty($foto)) { ?>
                            <img class="profile-user-img img-responsive" src="<?php echo base_url() . 'upload/staff/' . $foto; ?>" alt="<?php echo $nama_staff; ?>">
                        <?php } else { ?>
                            <img class="profile-user-img img-responsive" src="<?php echo base_url() . 'upload/noimage.jpg'; ?>" alt="<?php echo $nama_staff; ?>">
                        <?php } ?>
