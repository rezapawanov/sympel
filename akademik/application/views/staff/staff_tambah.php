        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
                    <form  class="form-horizontal" role="form" action="<?php echo base_url(); ?>pengguna/staff_save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-4 mr-2">
                            ...
                            <div class="form-group col-md-4 mr-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_staff" value="<?php echo $nama_staff; ?>" required>
                                    </div>
                                </div>
                               ...
                               <div class="form-group col-md-4 mr-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="aktif_staff"  required>
                                            <option value="1" <?php if($aktif_staff == '1') echo 'selected'; ?>>AKTIF</option>
                                            <option value="0" <?php if($aktif_staff == '0') echo 'selected'; ?>>TIDAK AKTIF</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-save"> </i> Simpan</button>
                            <a class="btn btn-default btn-lg" href="<?php echo base_url(); ?>pengguna/staff"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                <!-- /.card-footer -->
              </form>
            </div>
