        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>pengumuma"><?php echo $judul; ?></a></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>pengumuman/pengumuman_save" enctype="multipart/form-data" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <div class="input-group input-group">
                        <input type="text" class="form-control" name="judul_pengumuman" value="<?php echo $judul_pengumuman; ?>" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-5 col-form-label">Foto Informasi Pengumuman</label>
                    <div class="col-sm-12">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>pengumuman"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
