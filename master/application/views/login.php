...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/sympel/upload/'.$sekolah->logo; ?>" type="image/x-icon">
        ...
        <div class="login-container white animated fadeInDown" style="min-height: 00px;">
          ...
          <div class=" p-x-md m-t-lg"><br>
            <div class="text-center p-x-sm">
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/sympel/upload/'.$sekolah->logo; ?>" height='100px' class="apps "> <br><br>
