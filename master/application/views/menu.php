...
<aside class="main-sidebar sidebar-light-info elevation-4 animated fadeInLeft">
  ...
  <a href="<?php echo base_url(); ?>" class="brand-link ">
    <img src="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/sympel/master/upload/' . $sekolah->logo; ?>"
      alt="ASIS LOGO" class="brand-image img-rounded elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image animated fadeInLeft">
        <img src="<?php echo base_url(); ?>upload/user.jpg" class="img-rounded elevation-2"
          style="width:60px;height:70px;" alt="User Image">
      </div>
      <div class="info">
        ...
        <span class="badge badge-info right ">
          <?php echo ucfirst($this->session->userdata("hak_akses")); ?>
        </span>
    ...
    <center>
      <div class="btn-group btn-group-xs">
        <span class="right btn badge badge-danger btn-flat animated fadeInDown">
          <?php echo $hari . "&nbsp;";
          echo date('d') . "&nbsp;&nbsp;";
          echo $bln . "&nbsp;";
          echo date('Y'); ?>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
        ...
        <?php if ($this->session->userdata("tipe") == 'root') {
          ...
          <li class="nav-item has-treeview <?php if ($this->uri->segment(1) == 'user')
            echo 'active'; ?> treeview <?php if ($this->uri->segment(1) == 'user')
                 echo 'menu-open'; ?>">
