      ...
      <div class="row mb-2">
        <div class="col-sm-12 mt-1">
          <div class="card card-info card-outline">
            <center>
              <h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px #17a2b8;"><i
                  class="fal fa-desktop-alt mt-2"></i> <br>DAFTAR SYSTEM INFORMASI PELAJAR (SYMPEL)</h1>
            </center>
            <hr>

            <?php if ($this->session->userdata("tipe") == 'root') {
              ?>
              ...
              <div class="row ml-2 mr-2">
                  ...
                  <a href="../akademik" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-info"><b>AKADEMIK</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                  <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../kesiswaan" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-info"><b>KESISWAAN</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../keuangan" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-info"><b>KEUANGAN</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e">
                          <Versi class="2 1"></Versi>
                        </font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../perpustakaan" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-info"><b>PERPUSTAKAAN</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../alumni" target="_blank" style="color:black;">
                    <div class="info-box">
                      <span class="info-box-icon bg-purple elevation-1"><i class="fas fa-user-graduate"></i></span>
                      <div class="info-box-content">
                        <span class="info-box-text text-purple"><b>ALUMNI</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../kelulusan" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-danger"><b>KELULUSAN</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../sarpras" target="_blank" style="color:black;">
                    <div class="info-box">
                      <span class="info-box-icon bg-puprle elevation-1"><i class="fas fa-boxes"></i></span>
                      <div class="info-box-content">
                        <span class="info-box-text text-navy"><b>SARPRAS</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../arsip" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-navy"><b>ARSIP AKREDITAS</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../ppdb" target="_blank" style="color:black;">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text text-teal"><b>PPDB ONLINE</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../cbt/manager/" target="_blank" style="color:black;">
                    <div class="info-box">
                      <span class="info-box-icon bg-orange elevation-1"><i class="fas fa-laptop"></i></span>
                      <div class="info-box-content">
                        <span class="info-box-text text-orange"><b>CBT ADMIN</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="../e-learning" target="_blank" style="color:black;">
                    <div class="info-box">
                      <span class="info-box-icon bg-pink elevation-1"><i class="fas fa-graduation-cap"></i></span>
                      <div class="info-box-content">
                        <span class="info-box-text text-pink"><b>E-LEARNING</b></span>
                        <font size="1" style="text-shadow: 2px 2px 4px #827e7e"></font>
                      </div>
                    </div>
                  </a>
            ...
            <?php if ($this->session->userdata("tipe") == 'kepsek') {
              ?>
            ...
            <?php if ($this->session->userdata("tipe") == 'gurupiket') {
              ?>
                ...
                foreach ($slideshow->result_array() as $data_slideshow) {
                  ...
                  <div class="carousel-item <?php echo $active; ?>">
                    <img class="d-block w-100"
                      src="<?php echo base_url() . 'upload/' . $data_slideshow['file_gambar']; ?>">
                  </div>
                  <?php $no++;
                } ?>
              </div>
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-striped table-sm">
                ...
                <tbody>
                  <?php $no = 1;
                  foreach ($log_login->result_array() as $data) { ?>
                    <tr class="text-xs">
                      <td>
                        <?php echo $no; ?>
                      </td>
                      <td class="text-danger">
                        <?php echo $data['ipaddress']; ?>
                      </td>
                      <td>
