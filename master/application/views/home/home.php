        ...
        <div class="row mb-2">
          <div class="col-sm-12 mt-1">
            <div class="card card-info card-outline">
              <center><h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px #17a2b8;"><i class="fal fa-desktop-alt mt-2"></i> <br>DAFTAR SYSTEM INFORMASI PELAJAR (SYMPEL)</h1> </center>
              <hr>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <font size="1" style="text-shadow: 2px 2px 4px #827e7e"><Versi class="2 1"></Versi></font>
              </div>
            </div></a>
            <!-- /.info-box -->
          </div>
