                                          ...
                                          <div class="card-body p-0">
                                              <div class="row mt-3 ml-1 mr-1">
                                                      ...
                                                      <a style="color:black;">
                                                          <div class="info-box">
                                                              ...
                                                              <div class="info-box-content">
                                                                  ...
                                                                  <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_siswa; ?></span>
                                                              </div>
                                                          </div>
                                                      </a>
                                                  </div>
                                                  ...
                                                  <div class="col-md-4">
                                                      <a style="color:black;">
                                                          <div class="info-box">
                                                              <span class="info-box-icon bg-success elevation-1"><i class="far fa-check"></i></span>
                                                              <div class="info-box-content">
                                                      ...
                                                      <a style="color:black;">
                                                          <div class="info-box">
                                                              ...
                                                              <div class="info-box-content">
                                                                  ...
                                                                  <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_tolak; ?></span>
                                                              </div>
                                                          </div>
                                                      </a>
                                                  </div>
