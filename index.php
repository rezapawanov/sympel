  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href="master">login</a></li>
        </ul>
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="master" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>Login</span>
  ...
  <div class="row gy-4">
	...
	<div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
	  <div class="service-box blue">
		...
		<h3>PPDB</h3>
		<p>Penerimaan Siswa Didik Baru</p>
