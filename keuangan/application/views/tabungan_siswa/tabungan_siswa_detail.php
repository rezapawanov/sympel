        ...
        <div class="row mb-2" id="cetak">
          <div class="col-sm-12">
            <div class="card">
              ...
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/asispanel/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded " style="width:60px;height:60px;">
             ...
             <div class="container-fluid">
              ...
              <div class="col-md-12">
                    <div class="card card-danger card-outline">
                      <div class="card-header">
                        <h3 class="card-title text-danger" style="text-shadow: 2px 2px 4px #black;"><i class="fas fa-ballot"></i> DAFTAR DETAIL TABUNGAN SISWA <b>[<?php echo $nama_siswa; ?>]</b></h3>
                            ...
                            <?php
                                            ...
                                            foreach ($tabungan_siswa->result_array() as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">Rp <?php echo number_format($data['saldo']); ?></td>
                                                </tr>
                                                <?php $no++;
                                            } ?>
...
<?php
                                            $no = 1;
                                            foreach ($total->result_array() as $data) { ?>
                                                <tr>
                                                <td class="text-left">TOTAL</td>

                                                    <td colspan="3" class="text-left">Rp <?php echo number_format($data['saldo']); ?></td>
                                                </tr>
                                                <?php $no++;
                                            } ?>
                ...
                <div class="col-md-12">
                    <div class="card card-danger card-outline">
                      <div class="card-header">
                        <h3 class="card-title text-danger" style="text-shadow: 2px 2px 4px #black;"><i class="fas fa-ballot"></i> DAFTAR DETAIL PENGELUARAN SISWA <b>[<?php echo $nama_siswa; ?>]</b></h3>
                        <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                              </button>
                        </div>
                            ...
                            <?php
                                            ...
                                            foreach ($belanja_siswa->result_array() as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date("d-m-Y",strtotime($data['tanggal'])); ?></td>
                                                    <td><?php echo $data['nama_siswa']; ?></td>
                                                    <td class="text-right">Rp <?php echo number_format($data['harga']); ?></td>
                                                </tr>
                                                <?php $no++;
                                            } ?>
