        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>master/belanja_siswa"><?php echo $judul; ?></a></li>
        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>belanja_siswa/belanja_siswa_save" method="post">

              <input type="hidden" name="tipe" value="<?php echo $tipe; ?>">
              <input type="hidden" name="id_belanja_siswa" value="<?php echo $id_belanja_siswa; ?>">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input id="harga" type="text" class="form-control harga" name="harga" placeholder="Jumlah Belanja . . . " value="<?php echo $harga; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Tanggal Belanja</label>
                    <div class="col-sm-12">
    ...
    $(document).ready(function() {
      $('#cari-siswa').typeahead({
        source: function(query, result) {
          $.ajax({
            url: "<?php echo base_url(); ?>belanja_siswa/ajax_siswa",
            data: 'query=' + query,
            dataType: "json",
            type: "POST",
