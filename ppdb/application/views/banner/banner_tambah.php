              ...
              <div class="row">
                  ...
                  <div class="animated fadeInLeft col-md-8">
                      <div class="card card-info">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>banner/banner_save" method="post" enctype="multipart/form-data">
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-12">
                                          <input type="file" class="form-control" name="file_gambar" required>
                                      </div>
                                  </div>
                              ...
                              <div class="card-footer">
                                  ...
                                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>banner"><i class="fa fa-undo"> </i> Kembali</a>
                              </div>
                              <!-- /.card-footer -->
                          </form>
                      </div>
