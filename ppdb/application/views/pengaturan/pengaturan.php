                          ...
                          <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>pengaturan/pengaturan_save" method="post" enctype="multipart/form-data">
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-12"><center>
                                          <label class="col-sm-3 col-form-label text-uppercase">File Prosedur</label><br>
                                          <?php
                                            if (!empty($prosedur)) {
                                                echo '<img style="width:500px;height:700px;" src="' . base_url() . 'upload/' . $prosedur . '">';
                                            }
                                            ?></center><br>
                                          <input type="file" class="form-control" name="file_prosedur">
                                      </div>
                                  </div>

                                  <div class="form-group row"><center>
                                      <label class="col-sm-12 col-form-label text-uppercase">Tampilkan Pengumuman</label></center>
                                      <div class="col-sm-12">
                                          <select class="form-control" name="pengumuman" required>
                                              <option value="1" <?php if ($pengumuman == 1) echo 'selected'; ?>>Iya</option>
                                              <option value="0" <?php if ($pengumuman == 0) echo 'selected'; ?>>Tidak</option>
                                          </select>
                                      </div>
                                  </div>

                                  <div class="form-group row"><center>
                                      <label class="col-sm-12 col-form-label text-uppercase">Tentang PPDB</label></center>
                                      <div class="col-sm-12">
                                          <textarea style="height:200px;" class="form-control" name="tentang" required><?php echo $tentang; ?></textarea>
                                      </div>
                                  </div>
