                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              ...
                                              <select class="form-control select2" type="text" name="jenis_barang">
                                                  ...
                                                  <?php
                                                    ...
                                                    ?>
                                                      <tr>
                                                          ...
                                                          <td><?php echo $data['nomor_sarpras']; ?></td>
                                                          <td><?php echo $data['nama_sarpras']; ?></td>
                                                          <td><?php echo $data['tahun_ajaran']; ?></td>
                                                          <td><?php echo date("d-m-Y", strtotime($data['tanggal_sarpras'])); ?></td>
