          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text text-danger" ><b>JUMLAH SARPRAS</b></span>
                <span class="info-box-number " style="text-shadow: 2px 2px 4px #827e7e"><?php echo $hitung_sarpras; ?></span>
              </div>
            </div></a>
          </div>
          ...
          <div class="col-md-6">
            <div class="card card-info card-outline">
              <div class="card-header">
                <h3 class="card-title text-info"><i class="fas fa-file-alt"></i> Jumlah Barang</h3>
                ...
                foreach ($data_jenis->result_array() as $data) {
                  ...
                  $hitung_jenis = $this->db->query("SELECT COUNT(*) as hitung FROM sarpras WHERE id_jenis_barang = '$data[id_jenis_barang]'")->row();
