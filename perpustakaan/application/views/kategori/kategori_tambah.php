      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/kategori_save" method="post">
               ...
               <?php if($this->session->flashdata('error')) { ?>
                ...
                <div class="card-footer text-right">
                  <div class="btn-group btn-group-sm">
                    <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>master/kategori"><i class="fa fa-undo"> </i> Kembali</a>
