          ...
          <div class="animated fadeInUp col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               ...
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/buku_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
                    ...
                    <?php
                                ...
                                <tr class="text-sm">
                                    ...
                                    <td style="text-align:center; ">
                                        ...
                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'master/buku_edit/' . $data['id_buku']; ?>"><i class="fa fa-edit"> </i></a>
                                    </div>
                                    </td>
                                </tr>
                                <?php $no++;
