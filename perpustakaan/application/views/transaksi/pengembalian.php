                  ...
                  <tbody>
                    <tr>
                      <td style="vertical-align:middle;text-align:center;">
                        <a class="btn bg-navy" href="<?php echo base_url(); ?>transaksi/daftar_peminjaman"><i class="fa fa-list-alt"> </i> Daftar Transaksi Peminjaman </a>
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        ...
                        <td><input class="form-control nis" name="nis" type="text" value="<?php echo $nis; ?>" readonly></td>
                      </tr>
                      <tr>
                        <td style="vertical-align:middle;">Nama Siswa</td>
                        <td><input class="form-control nama_siswa" name="nama_siswa" type="text" value="<?php echo $nama_siswa; ?>" readonly></td>
                      </tr>
                      <tr>
                        <td style="vertical-align:middle;">Kelas</td>
                        <td><input class="form-control nama_kelas" name="nama_kelas" type="text" value="<?php echo $nama_kelas; ?>" readonly></td>
                      </tr>
                  </table>
                </div>
              </form>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php if($data['status_pinjam_dt'] == 1) { ?>
                        Selesai
                      <?php } else { ?>
                      <a class="btn btn-primary btn-xs" href="<?php echo base_url() . 'transaksi/pengembalian_simpan/' . $data['id_peminjaman_dt'] . '/' . $nis.'/'.$telat_in; ?>" onclick="return confirm('Yakin ingin mengembalikan buku ini ?');"><i class="fa fa-edit"> </i> Kembali</a></td>
