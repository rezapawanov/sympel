        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>master/lemari"><?php echo $judul; ?></a></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/lemari_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
                    ...
                    foreach ($lemari->result_array() as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url() . 'master/lemari_edit/' . $data['id_lemari']; ?>"><i class="fa fa-edit"> </i> Edit </a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
