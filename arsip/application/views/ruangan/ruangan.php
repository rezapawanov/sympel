        ...
        <div class="row mb-2">
          <div class="col-sm-6 mt-2">
            <h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px white;">
              <i class="fas fa-building nav-icon text-gray"></i> <?php echo $judul; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><i class="fas fa-home-lg-alt"></i> Home</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>master/ruangan"><?php echo $judul; ?></a></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/ruangan_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
                    ...
                    foreach ($ruangan->result_array() as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url() . 'master/ruangan_edit/' . $data['id_ruangan']; ?>"><i class="fa fa-edit"> </i> Edit </a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
