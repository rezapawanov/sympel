        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/ruangan_save" method="post">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>master/ruangan"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
