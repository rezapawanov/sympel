          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/jenis_dokumen_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
                    ...
                    foreach ($jenis_dokumen->result_array() as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url() . 'master/jenis_dokumen_edit/' . $data['id_jenis_dokumen']; ?>"><i class="fa fa-edit"> </i> Ubah </a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
