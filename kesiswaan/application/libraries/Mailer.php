...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'amanahidham@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Test Demo Email'; // Isikan dengan nama pengirim
    protected $password = 'Naktaubae404'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Subject = $data['perihal'];
        $mail->Body = $data['jenis_bimbingan_siswa'];
