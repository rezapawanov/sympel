          ...
          <div class=" col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>BarangSita/barangsita_siswa_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
              </div>
              <!-- /.card-header -->
                  ...
                  foreach($barangsita->result_array() as $data) { 
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;">
                        <a class="btn btn-info btn-xs" href="<?php echo base_url().'BarangSita/barangsita_siswa_edit/'.$data['id_barangsita_siswa']; ?>"><i class="fa fa-edit"> </i> Ubah </a>

                        <a class="btn btn-danger btn-xs" href="<?php echo base_url().'BarangSita/barangsita_siswa_hapus/'.$data['id_barangsita_siswa']; ?>"><i class="fa fa-trash"> </i> Hapus </a>
                      </td>
                    </tr>
                  <?php $no++; } ?>
                  </tbody>
