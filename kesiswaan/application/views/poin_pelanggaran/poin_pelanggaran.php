          ...
          <div class="animated fadeInUp col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/poin_pelanggaran_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
                  ...
                  foreach($poin_pelanggaran->result_array() as $data) { ?>
                    <tr>
                      ...
                      <td style="text-align:center;width:80px;">
                        <a class="btn btn-info btn-xs" href="<?php echo base_url().'master/poin_pelanggaran_edit/'.$data['id_poin_pelanggaran']; ?>"><i class="fa fa-edit"> </i>  </a> |
                        <?php if($data['id_poin_pelanggaran'] != "1") { ?>
                        <a class="btn btn-danger btn-xs" href="<?php echo base_url().'master/poin_pelanggaran_hapus/'.$data['id_poin_pelanggaran']; ?>" onclick="return confirm('Yakin ingin hapus data ? ');"><i class="fa fa-trash"> </i>  </a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php $no++; } ?>
