      ...
      <div class="container-fluid">
             ...
             <div class="container-fluid">
              ...
              <div class="col-md-12">
                    <div class="card card-danger card-outline">
                      <div class="card-header">
                        <h3 class="card-title text-danger" style="text-shadow: 2px 2px 4px #black;"><i class="fas fa-ballot"></i> DAFTAR DETAIL BIMBINGAN SISWA <b>[<?php echo $nama_siswa; ?>]</b></h3>
                            ...
                            <?php
                                            ...
                                            foreach ($bimbingan_siswa->result_array() as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $data['jenis_bimbingan_siswa']; ?></td>
                                                    <td class="text-right"><?php echo $data['perihal']; ?></td>
                                                </tr>
                                           <?php
                                              } ?>
        ...
        <div class="card-footer mb-2">
            <div class="btn-group btn-group-sm float-right">
                  <a class="btn btn-danger float-right" href="<?php echo base_url() . 'bimbingan_siswa'; ?>"><i class="fa fa-undo"> </i> Kembali</a>
