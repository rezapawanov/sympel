        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>master/bimbingan_siswa"><?php echo $judul; ?></a></li>
        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>bimbingan_siswa/bimbingan_siswa_save" method="post">

              <input type="hidden" name="tipe" value="<?php echo $tipe; ?>">
              <input type="hidden" name="id_bimbingan_siswa" value="<?php echo $id_bimbingan_siswa; ?>">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input id="email" type="text" class="form-control perihal" name="email" placeholder="Email . . . " value="<?php echo $email; ?>">
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label">Jenis Bimbingan</label>
                    <div class="col-sm-12">
                      <select id="cari-pelanggaran" class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%; " name="jenis_bimbingan_siswa">
                      <option>Layanan Orientasi</option>
                      <option>Layanan Informasi</option>
                      <option>Layanan Penempatan dan Penyaluran</option>
                      <option>Layanan Konseling Individu</option>
                      <option>Layanan Bimbingan Kelompok</option>
                      <option>Layanan Konseling Kelompok</option>
                      <option>Layanan Penguasaan Konten</option>
                      <option>Layanan Pembelajaran</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input id="perihal" type="text" class="form-control perihal" name="perihal" placeholder="Perihal Bimbingan . . . " value="<?php echo $perihal; ?>">
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>master/poin_pelanggaran"><i class="fa fa-undo"> </i> Kembali</a>
                  </div>
                </div>
                <!-- /.card-footer -->
              </form>
    ...
    $(document).ready(function() {
      $('#cari-siswa').typeahead({
        source: function(query, result) {
          $.ajax({
            url: "<?php echo base_url(); ?>bimbingan_siswa/ajax_siswa",
            data: 'query=' + query,
            dataType: "json",
            type: "POST",
