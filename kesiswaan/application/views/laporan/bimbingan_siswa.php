          ...
          <div class=" col-md-12">
            <div class="card card-info card-outline">
              <div class="card-header col-md-12">
                ...
                <form role="form" action="<?php echo base_url(); ?>laporan/proses_tampil_bimbingan" method="post">
                  <div class="row">
                    <div class="col-md-4">
              ...
              <!-- /.card-header -->
              <!-- TABLE: LATEST ORDERS -->
              <?php if (!empty($bimbingan_siswa)) { ?>
                <div class="card" id="cetak">
                  <div class="card-header border-transparent">
                    <center>
                        <h4 class="m-0 text-dark mt-3" style="text-shadow: 2px 2px 4px #17a2b8;">
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/sympel/master/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded " style="width:60px;height:60px;">
               <br><?php echo $nama_sekolah ?></h4>
                      <h4 style="margin:0;">Laporan Bimbingan Siswa </h4>
                    ...
                    <div class="table-responsive">
                      <table class="table m-0 table-hover">
                        ...
                        <tbody>
                          ...
                          $no = 1;
                          $total_poin = 0;
                          foreach ($bimbingan_siswa->result_array() as $data) {
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-sm" style="width:300px"><?php echo $data['jenis_bimbingan_siswa']; ?></td>
                              <td class="text-sm" class="text-center"><?php echo $data['perihal']; ?></td>
                            </tr>
                          <?php $no++;
                          } ?>
