  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="<?php echo base_url(); ?>app/save_biodata_admin" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_alumni" value="<?php echo $id_alumni; ?>">
      <div class="container-fluid">
        <!-- /.row -->
        <div class="animated fadeInLeft col-md-12">
            ...
            <div class="tab-pane fade show active mt-1" id="tab_1" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
              ...
              <div class="tab-pane fade show" id="tab_2" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Apakah Anda pernah bekerja setelah lulus dari SMK <span style=color:red;><?php echo $nama_sekolah ?></span> <span style="color:red;">*</span></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="info_kerja_1" <?php if($info_kerja_1 == 'SMK <span style=color:red;><?php echo $nama_sekolah ?></span>') echo 'checked'; ?> value="SMK <span style=color:red;><?php echo $nama_sekolah ?></span>"> SMK <span style=color:red;><?php echo $nama_sekolah ?></span>
                                                        </label>
                      </div><br>
                      <div class="icheck-success d-inline">
                        <label>
