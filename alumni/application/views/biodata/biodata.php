        ...
        <div class="animated fadeInLeft col-md-12">
            ...
            <div class="tab-pane fade show active mt-1" id="tab_1" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                       <input type="number" class="form-control" name="tahun_lulus" value="<?php echo $tahun_lulus; ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Aktivitas Saat Ini</label>
                    <div class="col-sm-12">
                      <div class="form-group clearfix">
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="aktivitas_1" <?php if($aktivitas_1 == 'Kerja') echo 'checked'; ?> value="Kerja"> Kerja
                                                        </label>
                      </div>&nbsp;
                      <div class="icheck-success d-inline">
                        <label>
                        <input type="checkbox" name="aktivitas_2"  <?php if($aktivitas_2 == 'Kuliah') echo 'checked'; ?> value="Kuliah"> Kuliah
                        </label>
                      </div>&nbsp;
                      <div class="icheck-info d-inline">
                        <label>
                                                            <input type="checkbox" name="aktivitas_3"  <?php if($aktivitas_3 == 'Wirausaha') echo 'checked'; ?> value="Wirausaha"> Wirausaha
                                                        </label>
                      </div>&nbsp;
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="aktivitas_4"  <?php if($aktivitas_4 == 'Yang Lain') echo 'checked'; ?> value="Yang Lain"> Yang Lain
                                                        </label>
                      </div>
                    </div>
                    </div>
              ...
              <div class="tab-pane fade show" id="tab_2" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Apakah Anda pernah bekerja setelah lulus dari <span style="color:red;"><?php echo $nama_sekolah ?></span></label>
                    <div class="col-sm-12">
                       <select class="form-control" name="pernah_bekerja" >
                                                        <option value>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="lama_dapat_kerja">
                                                        <option value>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="bidang_pekerjaan">
                                                        <option value>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="tingkat_kemudahan">
                                                        <option value>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="info_kerja_1" <?php if($info_kerja_1 == 'SMK <span style="color:red;"><?php echo $nama_sekolah ?></span>') echo 'checked'; ?> value="SMK <span style=color:red;><?php echo $nama_sekolah ?></span>"> <span style="color:red;"><?php echo $nama_sekolah ?></span>
                                                        </label>
                      </div><br>
                      <div class="icheck-success d-inline">
                        <label>
                                                            <input type="checkbox" name="info_kerja_2" <?php if($info_kerja_2 == 'Wirausaha') echo 'checked'; ?> value="Wirausaha"> Teman sesama Alumni
                                                        </label>
                      </div><br>
                      <div class="icheck-info d-inline">
                        <label>

                                                            <input type="checkbox" name="info_kerja_3" <?php if($info_kerja_3 == 'Internet') echo 'checked'; ?> value="Internet"> Internet
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="info_kerja_4" <?php if($info_kerja_4 == 'Saudara') echo 'checked'; ?> value="Saudara"> Saudara
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="info_kerja_5" <?php if($info_kerja_5 == ' Yang Lain') echo 'checked'; ?> value=" Yang Lain"> Yang Lain
                                                        </label>
                      </div>
                    </div>
                    </div>
                ...
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Berapa jumlah gaji yang Anda terima sebagai lulusan <span style="color:red;"><?php echo $nama_sekolah ?></span>?</label>
                    <div class="col-sm-12">
                     <select class="form-control" name="jumlah_gaji">
                                                        <option value>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="nama_tempat_kerja" value="<?php echo $nama_tempat_kerja; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="kabupaten_perusahaan" value="<?php echo $kabupaten_perusahaan; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control tglcalendar" name="tanggal_mulai_kerja" value="<?php echo $tanggal_mulai_kerja; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Sampai Dengan</label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control tglcalendar" name="tanggal_selesai_kerja" value="<?php echo $tanggal_selesai_kerja; ?>">
                    </div>
                </div>
                <div class="form-group row">
              ...
              <div class="tab-pane fade show" id="tab_3" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                       <select class="form-control select2" name="aktivitas_kuliah">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control select2" name="status_perguruan_tinggi">
                                                        <option value>Pilh</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="nama_perguruan_tinggi" value="<?php echo $nama_perguruan_tinggi; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                     <input type="text" class="form-control" name="program_studi" value="<?php echo $program_studi; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Jalur Masuk Perguruan Tinggi</label>
                    <div class="col-sm-12">
                     <select class="form-control select2" name="jalur_masuk" >
                                                        <option value>Pilh</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                     <input type="text" class="form-control tglcalendar" name="mulai_kuliah" value="<?php echo $mulai_kuliah; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Biaya Per Semester</label>
                    <div class="col-sm-12">
                     <input type="number" class="form-control" name="biaya_semester" value="<?php echo $biaya_semester; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Status Kuliah</label>
                    <div class="col-sm-12">
                     <select class="form-control" name="status_kuliah" >
                                                        <option value>Pilh</option>
              ...
              <div class="tab-pane fade mr-2" id="tab_4" role="tabpanel" aria-labelledby="custom-content-above-settings-tab">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                     <input type="text" class="form-control" name="nama_perusahaan_wirausaha" value="<?php echo $nama_perusahaan_wirausaha; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="jenis_usaha_1"  <?php if($jenis_usaha_1 == 'Jasa') echo 'checked'; ?> value="Jasa"> Jasa
                                                        </label>
                      </div>&nbsp;
                      <div class="icheck-success d-inline">
                        <label>
                                                            <input type="checkbox" name="jenis_usaha_2"  <?php if($jenis_usaha_2 == 'Barang') echo 'checked'; ?> value="Barang"> Barang
                                                        </label>
                      </div>&nbsp;
                      <div class="icheck-info d-inline">
                        <label>
                                                            <input type="checkbox" name="jenis_usaha_3"  <?php if($jenis_usaha_3 == 'Bidang Farmasi') echo 'checked'; ?> value="Bidang Farmasi"> Bidang Farmasi
                                                        </label>
                      </div>&nbsp;
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="jenis_usaha_4"  <?php if($jenis_usaha_4 == 'Yang Lain') echo 'checked'; ?> value="Yang Lain"> Yang Lain
                                                        </label>
                      </div>
                    </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                     <input type="text" class="form-control tglcalendar" name="mulai_usaha" value="<?php echo $mulai_usaha; ?>" >
                    </div>
                </div>
                 <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Status Wirausaha</label>
                    <div class="col-sm-12">
                      <select class="form-control" name="status_wirausaha" >
                                                        <option value>Pilh</option>
              ...
              <div class="tab-pane fade mr-2" id="tab_5" role="tabpanel" aria-labelledby="custom-content-above-settings-tab">
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Bagaimana kesesuaian Pengetahuan dan Keterampilan yang Anda peroleh dari <span style="color:red;"><?php echo $nama_sekolah ?></span></label>
                    <div class="col-sm-12">
                     <select class="form-control" name="kesesuaiaan_pengetahuan" >
                                                        <option value>Pilh</option>
                ...
                <div class="form-group row">
                    <label  class="col-sm-12 col-form-label">Bidang Kompetensi apa yang sudah diberikan oleh <span style="color:red;"><?php echo $nama_sekolah ?></span> dalam menunjang kinerja Anda dalam bekerja? <span style="color:red;">*</label>
                    <div class="col-sm-12">
                      <div class="form-group clearfix">
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kompetesi_1" <?php if($bidang_kompetesi_1 == 'Kompetensi Bidang Kefarmasian') echo 'checked'; ?> value="Kompetensi Bidang Kefarmasian"> Kompetensi Bidang Kefarmasian
                                                        </label>
                      </div><br>
                      <div class="icheck-success d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kompetesi_2" <?php if($bidang_kompetesi_2 == 'Kompetensi Bidang Pengetahuan Umum') echo 'checked'; ?> value="Kompetensi Bidang Pengetahuan Umum"> Kompetensi Bidang Pengetahuan Umum
                                                        </label>
                      </div><br>
                      <div class="icheck-info d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kompetesi_3" <?php if($bidang_kompetesi_3 == 'Kompetensi Bidang Sikap dan Perilaku') echo 'checked'; ?> value="Kompetensi Bidang Sikap dan Perilaku"> Kompetensi Bidang Sikap dan Perilaku

                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kompetesi_4" <?php if($bidang_kompetesi_4 == 'Kompetensi Bidang Religius') echo 'checked'; ?> value="Kompetensi Bidang Religius"> Kompetensi Bidang Religius
                                                        </label>
                      </div>
                    </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_1" <?php if($bidang_kefarmasian_1 == 'Ilmu Resep & Praktikum') echo 'checked'; ?> value="Ilmu Resep & Praktikum"> Ilmu Resep & Praktikum
                                                        </label>
                      </div><br>
                      <div class="icheck-success d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_2" <?php if($bidang_kefarmasian_2 == 'Farmakologi') echo 'checked'; ?> value="Farmakologi"> Farmakologi
                                                        </label>
                      </div><br>
                      <div class="icheck-info d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_3" <?php if($bidang_kefarmasian_3 == 'Farmakognosi') echo 'checked'; ?> value="Farmakognosi"> Farmakognosi
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_4" <?php if($bidang_kefarmasian_4 == 'Manajemen Farmasi') echo 'checked'; ?> value="Manajemen Farmasi"> Manajemen Farmasi
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_5" <?php if($bidang_kefarmasian_5 == 'Kimia Farmasi Analisis') echo 'checked'; ?> value="Kimia Farmasi Analisis"> Kimia Farmasi Analisis
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_6" <?php if($bidang_kefarmasian_6 == 'Peraturan Perundang-undangan') echo 'checked'; ?> value="Peraturan Perundang-undangan"> Peraturan Perundang-undangan
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_7" <?php if($bidang_kefarmasian_7 == 'IKM') echo 'checked'; ?> value="IKM"> IKM
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_8" <?php if($bidang_kefarmasian_8 == 'Sinonim') echo 'checked'; ?> value="Sinonim"> Sinonim
                                                        </label>
                      </div><br>
                      <div class="icheck-warning d-inline">
                       <label>
                                                            <input type="checkbox" name="bidang_kefarmasian_9" <?php if($bidang_kefarmasian_9 == 'Yang lain') echo 'checked'; ?> value="Yang lain"> Lainnya
                                                        </label>
                      </div>
                    </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_1" <?php if($bidang_pengetahuan_1 == 'Matematika') echo 'checked'; ?> value="Matematika"> Matematika
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_2" <?php if($bidang_pengetahuan_2 == 'Bahasa Inggris') echo 'checked'; ?> value="Bahasa Inggris"> Bahasa Inggris
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_3" <?php if($bidang_pengetahuan_3 == 'Bahasa Indonesia') echo 'checked'; ?> value="Bahasa Indonesia"> Bahasa Indonesia
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_4" <?php if($bidang_pengetahuan_4 == 'Fisika') echo 'checked'; ?> value="Fisika"> Fisika
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_5" <?php if($bidang_pengetahuan_5 == 'Kimia') echo 'checked'; ?> value="Kimia"> Kimia
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_6" <?php if($bidang_pengetahuan_6 == 'Biologi') echo 'checked'; ?> value="Biologi"> Biologi
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                        <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_7" <?php if($bidang_pengetahuan_7 == 'PPKn') echo 'checked'; ?> value="PPKn"> PPKn
                                                        </label>
                      </div><br>
                      <div class="icheck-danger d-inline">
                       <label>
                                                            <input type="checkbox" name="bidang_pengetahuan_8" <?php if($bidang_pengetahuan_8 == 'Yang lain') echo 'checked'; ?> value="Yang lain"> Yang lain
                                                        </label>
                      </div><br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="materi_ditingkatkan" value="<?php echo $materi_ditingkatkan; ?>" >
                    </div>
                </div>
                 <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="info_loker" >
                                                        <option value>Pilh</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="saran" value="<?php echo $saran; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="kesan" value="<?php echo $kesan; ?>" >
                    </div>
                </div>
              </div>
            </div>
            </div>
            <button type="submit" class="btn btn-success mr-2 ml-2 mb-2"><i class="fa fa-save"> </i> Simpan </button>
            </div>
