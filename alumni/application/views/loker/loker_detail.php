        ...
        <div class="row mb-2">
          <div class="col-sm-12 mt-2">
            <div class="card card-info card-outline">
              <center><h1 class="m-0 text-dark mt-2" style="text-shadow: 2px 2px 4px #17a2b8;"><i class="fal fa-tv-alt fa-2x"></i> <br>INFORMASI LOWONGAN KERJA<br><?php echo $judul_loker; ?></h1> </center>
              <hr>
