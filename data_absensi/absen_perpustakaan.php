    ...
    if ($resultSiswaCount) {
        ...
        if ($siswaCount > 0) {
            ...
            if ($result) {
                ...
                $query = "insert into absen(id_siswa, id_kelas, tahun_ajaran, keterangan, tanggal_absen) values ('$id_siswa', '$id_kelas', '2023/2024','PERPUSTAKAAN','$currentDate') ";
                mysqli_query($koneksi, $query);
            }
        }
    ...
    if ($resultGuruCount) {
        ...
        if ($guruCount > 0) {
            ...
            if ($result) {
                ...
                // Now, you can use the retrieved "tag" value in your INSERT query
                $query = "insert into absen_guru(id_guru, id_kelas, tahun_ajaran, keterangan, id_jadwal_pelajaran,tanggal_absen) values ('$id_guru', '$id_kelas', '2023/2024','PERPUSTAKAAN','$id_jadwal_pelajaran','$currentDate') ";
                mysqli_query($koneksi, $query);
            }
        }
