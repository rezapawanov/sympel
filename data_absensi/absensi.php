...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	<style type="text/css">
		...
		h1 {
			font-family: "Lucida Sans Unicode", "Lucida Grande", "Segoe goe Ui";
		}
				h2 {
			font-family: "Lucida Sans Unicode", "Lucida Grande", "Segoe goe Ui";
		}
...
<!-- Navbar (sit on top) -->
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
	...
	<table class="data-table">
		...
		<caption class="title">Data Absensi Karyawan</caption>
				<center>
		<form method="get">
		...
		if(isset($_GET['tanggal'])){
				...
				$sql = mysqli_query($koneksi,"select * from rfid JOIN siswa ON rfid.tag=siswa.tag where tanggal='$tanggal'");
			} else{
				$sql = mysqli_query($koneksi,"select * from rfid JOIN siswa ON rfid.tag=siswa.tag");
			}
